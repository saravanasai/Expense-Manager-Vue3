<template>
    <div class="navbar navbar-expand-md navbar-dark navbar-overlap d-print-none">
        ...
        ">
                <router-link :to="{ name: 'home' }">
                    <img :src="Logo" alt="Expense Manager" class="navbar-brand-image" width="110" height="32" />
                </router-link>
            </h1>
          ...
          ">
                            ...
                            <router-link class="nav-link" :to="{ name: 'about-us' }">
                                <span class="nav-link-icon d-md-none d-lg-inline-block">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                        class="icon icon-tabler icon-tabler-vocabulary" width="24" height="24"
                                        viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                                        stroke-linecap="round" stroke-linejoin="round">
                                        <desc>
            ...
            <!--end mobile view top menu section  -->
        </div>
    </div>
</template>
